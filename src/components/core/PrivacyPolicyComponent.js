  ...
  render() {
    return (
      <div className="container">
        ...
        <div>
          <p>
            Thank you for choosing to be part of our community at Job Pool
        ...
        <div>
          ...
          <div>
            <p>
              ...
              contact us. The personal information that we collect depends on
              the context of your interactions with us and the Website, the
              ...
              preferences; contact or authentication data; mailing addresses;
              job titles; and other similar information. All personal
              information that you provide to us must be true, complete and
              accurate, and you must notify us of any changes to such personal
              information.t data we collect
            </p>
          </div>
        </div>
        <div>
        ...
        <div>
          <div>
            ...
            <p>
              ...
              us at jobpool@gmail.com or by post to: Job Pool 360, HUNTINGTON
              AVENUE Boston, MA 02114 United States
            </p>
          </div>
        </div>
        <div>
          <p>
            To continue using our website, accept our privacy policy.
            Alternatively, you may choose to decline our privacy policy.
          </p>
        </div>
      </div>
    );
